...
class Employee:
    ...
    def __init__(self,name, eid, department):
        '''build a dictionary with eid as the key'''
        self.employee = {}
        self.employee['eid'] = eid
        self.employee['data'] = [name, department]
        print ('Employee craete:', end =" ")
...
if __name__ == '__main__':
    ...
    my_depart.add_employee(new_employee.employee)
